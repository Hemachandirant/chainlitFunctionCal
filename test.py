...
if uploaded_files is None:
  ...
  #extract embeddings
  embeddings = OpenAIEmbeddings(openai_api_key = "bd38ee31e244408cacab3e1dd4c32221")
  ...
  #initiate model
  llm = OpenAI(model_name=model_name, openai_api_key = "bd38ee31e244408cacab3e1dd4c32221", streaming=True)
